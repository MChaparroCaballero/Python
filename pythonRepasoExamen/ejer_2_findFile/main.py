...
#este programa recibe por linea de comandos el nombre de un archivo de texto y una cadena o caracter
# y muestra por consola/terminal cuantas veces aparece dicha cadena o caracter en el archivo diferenciando mayusculas y minusculas
