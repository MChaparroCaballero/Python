...
try:
    ...
    try:
        with open(nombre_archivo_general, 'w', encoding='utf-8') as archivo_salida:
            ...
            archivo_salida.write("Total de partidas: "+total_partidas)
            archivo_salida.write("Total de jugadores distintos: "+len(nicknames))
            archivo_salida.write("Puntuacion media global: "+puntuacion_media)
